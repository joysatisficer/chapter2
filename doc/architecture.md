...
Managing API keys. chapter2 follows [vendors.yaml](https://github.com/CrazyPython/vendors.yml) looks for `intermodel.callgpt` API keys `~/.config/chapter2/vendors.yaml`, `ems/vendors.yaml`, and the `vendors` parameter of the em.

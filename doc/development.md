...
1. Clone [embedapi](https://github.com/CrazyPython/embedapi) to `../modules/embedapi` (relative to the root of Chapter 2)
```bash
git clone https://github.com/CrazyPython/embedapi ../modules/embedapi
```
2. Clone [intermodel](https://github.com/CrazyPython/intermodel) to ../intermodel
```bash
git clone https://github.com/CrazyPython/intermodel ../intermodel
```
